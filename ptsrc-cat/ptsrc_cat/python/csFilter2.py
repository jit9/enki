...
def optimalFilter(mp):#, signalTransform = None):
    ...
    pNoise = liteMap1.fftTools1.powerFromLiteMap(mp)
    pNoise = pNoise.powerMap
    pNoise = liteMap1.liteMapFromDataAndWCS(pNoise, mp.wcs)
...
#    filtered = numpy.real(liteMap1.fftTools1.ifft2(u))

#    filtered = liteMap1.liteMapFromDataAndWCS(filtered, mp.wcs)
